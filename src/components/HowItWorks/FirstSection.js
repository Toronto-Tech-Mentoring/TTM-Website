...
export default function VolunteerRunOrg() {
  ...
  const content = 'Toronto Tech Mentoring was built to address some of the major gaps in accessing skills training for people who’ve faced adversity. If you’ve faced, or are facing, housing instability, we want to help you reach your tech learning goals.';
  return (
    <div>
      <CheetoLeft
