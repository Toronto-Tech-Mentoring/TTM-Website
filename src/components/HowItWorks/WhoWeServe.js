...
export default function VitalRole() {
  ...
  const content1 = 'We provide tech mentoring to anyone who has faced housing instability and is interested in learning tech skills.';
  const content2 = 'We don’t prescribe a certain project or learning outcome. Instead, we work with you to develop your own goals and a project that aligns with those.';
      ...
      <Hidden smDown>
        <Grid item xs={12} md={6}>
          <SVGLoad
            image={Group}
            alt="group 99 svg"
            style={{ paddingTop: '0', marginTop: '138px' }}
          />
        </Grid>
      </Hidden>
      <Grid item xs={12}>
