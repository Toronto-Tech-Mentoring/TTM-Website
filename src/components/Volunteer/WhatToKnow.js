...
export default function WhatToKnow() {
  ...
  const leftText = 'Toronto Tech Mentoring exists to provide options for vulnerable people. This means that volunteering with us requires empathy, sensitivity, and confronting the myriad of causes of housing instability.';
  const rightText = 'This is especially true for mentoring, which also requires a long term (minimum six months) commitment so that we can ensure stability for our clients.';
