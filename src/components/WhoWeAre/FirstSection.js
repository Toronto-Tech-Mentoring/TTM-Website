...
export default function VolunteerRunOrg() {
  ...
  const content = 'Our diverse team includes talented technologists, educators, program managers, and activists. We come from different professional backgrounds and many different walks of life — all tied together by our common goal: to help young people and adults that are underhoused, face barriers and adversity to write their own stories.';
