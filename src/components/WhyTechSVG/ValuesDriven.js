    ...
    return (
        <div>
            <svg viewBox="0 0 841 444" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <foreignObject x="120" y="110" width="600" height="50" className={classes.cssHeaderText}> 
                    We are a values-driven organization
                </foreignObject>

                <foreignObject className={classes.cssUnderline} x="120" y="110" width="460" height="39"></foreignObject>
