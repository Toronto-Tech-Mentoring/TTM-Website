...
export default function WhyTech() {
    ...
    <div className={classes.root}>
        ...
        <svg width="855" height="536" viewBox="0 0 855 536" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <foreignObject className={classes.cssHeaderText} x="160" y="148" width="855" height="536">
                Why tech?
            </foreignObject>

            <foreignObject className={classes.cssBodyText} x="160" y="210" width="600" height="536">
