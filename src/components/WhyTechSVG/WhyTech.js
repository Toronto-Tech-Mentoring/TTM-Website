    ...
    return (
        <div>
           <svg viewBox="0 0 855 536" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <foreignObject className={classes.cssHeaderText} x="160" y="155" width="174" height="39">
                    Why tech?
                </foreignObject>

                <foreignObject className={classes.cssUnderline} x="160" y="155" width="130" height="39"></foreignObject>
