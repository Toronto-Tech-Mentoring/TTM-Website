...
import DonateButton from '../Navbar/DonateBtn';
...
export default function HowYouCanSupport() {
  ...
  const paypalInfo = 'Monetary donations provide us the most flexibility to deliver our services to meet the exact needs of our participants how and when they need it.';
  const inKind = '2. Donate in kind';
  const inKindInfo = 'Toronto Tech Mentoring has a need for essential resources that will help us offer our program which in turn contributes to helping the LGBTQ homeless youth community.';
  const volunteer = '3. Volunteer Your Time';
  const volunteerInfo = 'If you are a company or organization interested in donating staff time to support our program, or have other ideas, please get in touch.';
  ...
  return (
    <div className={classes.container}>
      <div>
        ...
        <div className={classes.donateStyle}>
          <DonateButton />
        </div>
