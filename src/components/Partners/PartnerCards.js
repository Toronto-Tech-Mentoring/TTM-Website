...
export default function Cards() {
  ...
  return (
    <>
      ...
      >
        <Grid item xs={12}>
          <p className={`${classes.titleSpacing}  ${classes.text}`}>
        ...
        <Grid item xs={12} sm={4} md={3} lg={3} xl={2}>
          <Card className={classes.card}>
            <div
              className={`${classes.imgDiv}  ${classes.bg1}`}
        ...
        <Grid item xs={12} sm={4} md={3} lg={3} xl={2}>
          <Card className={classes.card}>
            <div
              className={`${classes.imgDiv}  ${classes.bg2}`}
        ...
        <Grid item xs={12} sm={4} md={3} lg={3} xl={2}>
          <Card className={classes.card}>
            <div
              className={`${classes.imgDiv}  ${classes.bg3}`}
            ...
            <CardContent>
              <p className={classes.contents}>
                Providing skills training for underhoused or vulnerable
                populations
              </p>
            </CardContent>
          </Card>
